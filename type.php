...
class Type
{
    ...
    static $output_folder = "\\output\\types\\";
    ...
    {
        $content = file_get_contents(dirname(__FILE__) . "\\template_type_header.th");
        return $content;
    }

    function getSrcTemplate()
    {
        $content = file_get_contents(dirname(__FILE__) . "\\template_type.th");
        return $content;
    }
    ...
    {
        $writeName = dirname(__FILE__) . Type::$output_folder . $this->src_name;
    ...
    {
        $writeName = dirname(__FILE__) . Type::$output_folder . $this->header_name;
